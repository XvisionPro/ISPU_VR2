...
namespace UITween
{
    public class CurrentAnimation
    {
        ...
        public void PlayOpenAnimations()
        {
            ...
            if (animationPart.PositionPropetiesAnim.IsPositionEnabled())
            {
                SetCurrentAnimPos(animationPart.PositionPropetiesAnim.TweenCurveEnterPos,
                    ...
                    animationPart.PositionPropetiesAnim.MiddlePos,
        ...
        public void SetCurrentAnimPos(AnimationCurve currentAnimationCurvePos, Vector3 currentStartPos, Vector3 currentMiddlePos, Vector3 currentEndPos)
        {
            this.currentAnimationCurvePos = currentAnimationCurvePos;
            this.currentStartPos = currentStartPos;
            this.currentMiddlePos= currentMiddlePos;
        ...
        public void MoveAnimation(RectTransform _rectTransform, float _counterTween)
        {
            ...
            float delta = -4 * Mathf.Pow(evaluatedValue, 2) + 4 * evaluatedValue;
            Vector3 valueAdded = (currentEndPos - currentStartPos) * evaluatedValue + delta * currentMiddlePos;
